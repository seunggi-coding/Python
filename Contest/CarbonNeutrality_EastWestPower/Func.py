...
def Five_VehicleSystem(day2, people, car_num, point):
    ...
    if month == 1 or  month == 3 or month == 5 or month == 7 or month == 8 or month == 10 or month == 12:
        ...
        for i in range(1, 28):
            if (car_num == 1 or car_num == 6) and (day2 == "1" or day2 == "6" or day2 == "11" or day2 == "16" or day2 == "21" or day2 == "26"):
                ...
                print("오늘은 {}일 이므로 차량번호 끝자리가 {}인 차량의 이용을 자제해 주시면 감사하겠습니다.".format(day2, car_num))
            elif (car_num == 4 or car_num == 9) and (day2 == "4" or day2 == "9" or day2 == "14" or day2 == "19" or day2 == "24"):
                print("오늘은 {}일 이므로 차량번호 끝자리가 {}인 차량의 이용을 자제해 주시면 감사하겠습니다.".format(day2, car_num))
            elif (car_num == 5 or car_num == 0) and (day2 == "5" or day2 == "10" or day2 == "15" or day2 == "20" or day2 == "25"):
                print("오늘은 {}일 이므로 차량번호 끝자리가 {}인 차량의 이용을 자제해 주시면 감사하겠습니다.".format(day2, car_num))
            break
